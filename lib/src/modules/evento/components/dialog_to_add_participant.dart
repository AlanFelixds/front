...
import 'package:front_flutter/src/modules/evento/components/card_to_list_participants.dart';
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: CustomButton(
                            onPressed: () async {
                              await controller.adicionarParticipante(eventID: controller.events[indexEvent].id!);
                              await controller.listaParticipantes(eventID: controller.events[indexEvent].id!);
                            },
